...
Some functionality from Civitai, like downloading models, requires having an account and adding you API key. See this ![Wiki Article](https://github.com/zixaphir/Stable-Diffusion-Webui-Civitai-Helper/wiki/Civitai-API-Key) for more information.
