...
* New Feature: Select Preview Image when downloading models
  * Also NSFW preview filtering has been updated to per-feature. The NSFW option in settings now sets the defaults for each.
